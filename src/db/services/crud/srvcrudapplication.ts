...
export async function insert(item_serial:string): Promise<string> {
    ...
    try {
        ...
        if (result === null) {
            return JsonResponse.ERROR
                (DpOpsUtil.getErrNotFoundMessage(DbOps.INSERT, DbTables.application));
        }
    }
    catch (error) {
    ...
    return JsonResponse.SUCCESS(DpOpsUtil.getOpName(DbTables.application,DbOps.INSERT), null);
}//end
...
export async function update(item:Application): Promise<string> { 
    ...
    return JsonResponse.SUCCESS(DpOpsUtil.getOpName("application", DbOps.UPDATE), null);
}//end
...
export async function delette(id: number): Promise<string> {
    ...
    try {
        ...
        if (result === null) {
            return JsonResponse.ERROR(DpOpsUtil.getErrNotFoundMessage(DbOps.DELETE, DbTables.application));
        }          
    }
    catch (error) {
        return JsonResponse.ERROR(DpOpsUtil.getErrMessage(error));
    ...
    return JsonResponse.SUCCESS(DpOpsUtil.getOpName("application", DbOps.DELETE),null);
}//end
...
export async function deleteAll(): Promise<string> {
    ...
    try {
        ...
        if (result === null) {
            return JsonResponse.ERROR(DpOpsUtil.getErrNotFoundMessage(DbOps.DELETE_ALL, DbTables.application));
        }          
    }
    catch (error) {
        return JsonResponse.ERROR(DpOpsUtil.getErrMessage(error));
    ...
    return JsonResponse.SUCCESS(DpOpsUtil.getOpName("application", DbOps.DELETE_ALL),null);
}//end
