...
export async function insert(item_serial:string): Promise<string> {
    ...
    return JsonResponse.SUCCESS(OpUtil.getOpName(DbTables.tasktype,DbOps.INSERT), null);
}//end
...
export async function update(item:Tasktype): Promise<string> { 
    ...
    return JsonResponse.SUCCESS(OpUtil.getOpName("tasktype", DbOps.UPDATE), null);
}//end
...
export async function delette(id: number): Promise<string> {
    ...
    return JsonResponse.SUCCESS(OpUtil.getOpName("tasktype", DbOps.DELETE),null);
}//end
...
export async function deleteAll(): Promise<string> {
    ...
    return JsonResponse.SUCCESS(OpUtil.getOpName("tasktype", DbOps.DELETE_ALL),null);
}//end
